...
const AppDialogWrapper = ({ dialogEventTarget }) => {
    ...
    const [dialogData, setDialogData] = useState<{ dialogs: Dialog[]} | null>(null);
    ...
    return (
        <ChaynsHost type={'client-module'} system={{module: './AppWrapper', url: 'https://tapp-staging.chayns-static.space/api/dialog-v2/v1/remoteEntry.js', scope: 'dialog_v2'}} {...data} functions={functions} customData={dialogData ||{}} />
    )
}
